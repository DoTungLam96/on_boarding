...
class DashPainter extends CustomPainter {
  ...
  Path _getPath(Size size) {
    ...
    switch (borderType) {
      ...
      case BorderType.Oval:
        ...
        break;
      case BorderType.Veritcal:
        path = _getVerticalLinePath(size);
        break;
      case BorderType.Horizontal:
        path = _getHorizontalLinePath(size);
        break;
    }

    return borderPath(path, dashArray: CircularIntervalList(dashPattern));
  }
  ...
  Path _getVerticalLinePath(Size size) {
    return Path()..lineTo(0, size.height);
  }

  Path _getHorizontalLinePath(Size size) {
