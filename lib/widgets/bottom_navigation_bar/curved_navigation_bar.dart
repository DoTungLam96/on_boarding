...
import 'package:flutter_on_boarding/widgets/card_container.dart';
...
class CurvedNavigationBarState extends State<CurvedNavigationBar>
  ...
  void initState() {
    ...
    _iconActive = widget.items[widget.index].activeIcon;
    ...
    _animationController.addListener(() {
      setState(() {
        ...
        if ((endingPos - _pos).abs() < (_startingPos - _pos).abs()) {
          ...
          _iconActive = widget.items[_endingIndex].activeIcon;
        }
        _buttonHide =
          ...
          Positioned(
            ...
            child: Center(
              child: Transform.translate(
                ...
                child: Material(
                  color: widget.bgActive ?? Colors.red,
              ...
              child: Row(
                children: widget.items.map((item) {
                  return NavBarItemWidget(
                    ...
                    position: _pos,
                    length: _length,
                    isActive: _endingIndex == widget.items.indexOf(item),
                    index: widget.items.indexOf(item),
                    child: Center(child: item.child),
                    label: item.label,
                    labelStyleActive: item.labelStyleActive,
